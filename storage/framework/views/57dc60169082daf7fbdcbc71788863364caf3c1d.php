...
<body>
    <form method="POST" action="<?php echo e(route('dgs.post')); ?>">

        <!--token eşleşirse post işlemine izin veriyor.-->
        <?php echo csrf_field(); ?>

        <h2 align="center">DGS BAŞVURU</h2>
...
</html><?php /**PATH C:\xampp\htdocs\student_system\resources\views/student_pages/dgs.blade.php ENDPATH**/ ?>