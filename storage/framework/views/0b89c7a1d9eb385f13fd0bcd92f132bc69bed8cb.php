...
<body>
    <form method="POST" action="<?php echo e(route('ders_intibak.post')); ?>">

        <!--token eşleşirse post işlemine izin veriyor.-->
        <?php echo csrf_field(); ?>

        <h2 align="center">DERS İNTİBAK BAŞVURU</h2>
...
</html><?php /**PATH C:\xampp\htdocs\student_system\resources\views/student_pages/ders_intibaki.blade.php ENDPATH**/ ?>