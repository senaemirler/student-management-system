...
<body>
    <form method="POST" action="<?php echo e(route('yatay_gecis.post')); ?>">

        <!--token eşleşirse post işlemine izin veriyor.-->
        <?php echo csrf_field(); ?>

        <h2 align="center">YATAY GEÇİŞ BAŞVURU</h2>
...
</html><?php /**PATH C:\xampp\htdocs\student_system\resources\views/student_pages/yatay_gecis.blade.php ENDPATH**/ ?>